...
**Quando os estilos são escritos com o *StyleSheet* da lib `@geekie/css`, é necessário aplicar os helpers**.
Caso forem escritos com o *StyleSheet* do `react-native` - ou com `F8StyleSheet` - **os helpers não devem ser aplicados**, mesmo que o arquivo seja somente para a web.
