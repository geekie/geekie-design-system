...
<div style={{display: "flex", flexDirection: "row", alignItems: "center"}}>
    ...
    <div style={{marginLeft: 60, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center"}}>
        <div>
            Aqui encontramos a **definição dos presets**, que está padronizada de acordo com nossos tokens.
            
            O preset de tipografia é **`$DSA_BASIC_HEADING_H2_STYLE`**:
        ...
        <br />
        <div>
            Aqui encontramos a **definição de cores**, que está padronizada de acordo com nossos tokens.
            
            O token de cor é **`$DSA_COLOR_NEUTRAL_XXDARK`**:
...
São as encontradas no arquivo `Colors.ts`. Essas duas definições coexistirão, por hora. Mas, focaremos aqui nas substituições das cores dos arquivo, pelas cores do DS.
...
Essa adaptação só se torna necessária, em uma tela web que usa um polyfill do RN, quando os estilos são escritos com a lib `@geekie/css`.

Seguindo a mesma lógica, também é necessário usar um helper para aplciar os presets nos casos webOnly. Usando os mesmos exemplos do tópico anterior, a aplciação dos presets com o helper fica das seguintes formas:
